...
stdx::native_simd<T> sin_stdlib(const stdx::native_simd<T>& xInput) {
  return stdx::sin(xInput);
}
...
const stdx::native_simd<T> halfPi = copal::num::pi_over_2<T>;
  ...
  if (stdx::any_of(invalidIndex_i)) {
    stdx::where(invalidIndex,   index_f ) = copal::lut::max_index_i;
    stdx::where(invalidIndex,   index_Af) = copal::lut::max_index_i;
    stdx::where(invalidIndex_i, index_A ) = copal::lut::max_index_i;
    stdx::where(invalidIndex_i, index_B ) = copal::lut::max_index_i;
  }
